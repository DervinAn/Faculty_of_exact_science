...
fun EventSlider(
    ...
    val events = listOf(Event("Event 1", "Lorem ipsum dolor sit amet, conslit.", "Date 1", "Time 1"), Event("Event 2", "Lorem ipsum dolor sit amet, conslit.", "Date 2", "Time 2"), Event("Event 3", "Lorem ipsum dolor sit amet, conslit.", "Date 3", "Time 3"),)
